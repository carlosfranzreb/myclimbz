...
def create_app():
    ...
    from myclimbz.blueprints.routes.routes import routes
    from myclimbz.blueprints.climbs.routes import climbs
    ...
    def check_request_validity():
        ...
        if "edit" in request.endpoint or "delete" in request.endpoint:
            ...
            if cls_str == "Password":
                cls_str = "Climber"
            cls = getattr(import_module("myclimbz.models"), cls_str)
